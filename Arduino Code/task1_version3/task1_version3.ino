...
void readColorSensors() 
{
  ...
  if((RblueCol <= 0) && (RredCol >= -30 && RredCol <= 150) && (RgreenCol <= 0))
  {
  ...
  if((MblueCol >= 150 && MblueCol <= 250) && (MredCol <= 70) && (MgreenCol <= 150))
  {
...
void grab(){
  for(int i = 0; i <= 50; i++)
  {
    ...
    {    
      ...
      if(GripperPosition >= 135 && GripperPosition <= 150)
      {
        Size = 1;
      }
